...
<footer class="footer">
	<div class="container footer__container">
		...
		<div class="footer__contacts">
			...
			<a class="contacts__item contacts__item_mail email-info" href="mailto:<? echo $cont['email']; ?>">
				<? echo $cont['email']; ?>
			</a>
			...
			<ul class="social footer__social">
				<li class="social__item">
					<a class="social__link social__link_telegram telegram-info" target="_blank" href="https://t.me/+<? echo preg_replace('/[^0-9\.]+/', '', $cont['tel']); ?>">
				...
				<li class="social__item">
					<a class="social__link social__link_whatsapp whatsapp-info" target="_blank" href="https://api.whatsapp.com/send?phone=<? echo preg_replace('/[^0-9\.]+/', '', $cont['tel']); ?>">
						<svg width="27" height="26" viewBox="0 0 27 26" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				<li class="social__item">
					<a class="social__link social__link_viber viber-info" target="_blank" href="viber://chat?number=%2B<? echo preg_replace('/[^0-9\.]+/', '', $cont['tel']); ?>">
						<svg width="27" height="26" viewBox="0 0 27 26" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path fill-rule="evenodd" clip-rule="evenodd"
