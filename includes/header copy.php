	...
	<div class="burger burger__master">
		...
		<div class="burger__top_bottom">
			<div class="burger__tel">
				<a href="tel:<?=$row['tel'];?>" class="burger__tel_title"><?=$row['tel'];?></a>
        ...
        <div class="header__top container">
			...
			<div class="header__top_left">
				<div class="header__top_left_item">
					<a href="tel:<?=$row['tel'];?>" class="top_left_item_title address__subtitle_underline"><?=$row['tel'];?></a>
...
-->
			...
			<div class="address__production">
				...
				<div class="address__subtitle_items">
					<div class="address__subtitle_item">
						<img src="/css/img/ico__map.svg" alt="Иконка карты">
						<a href="/pages/contacts/" class="address__subtitle"><?=$row['address'];?></a>
					</div>
					<div class="address__subtitle_item">
						<img src="/css/img/ico__tel.svg" alt="Иконка телефона">
						<a href ="tel:<?=$row['tel'];?>" class="address__subtitle address__subtitle_underline"><?=$row['tel'];?></a>
					</div>
				</div>
			</div>
		...
		<?php
			if($_SERVER['REQUEST_URI'] == '/') {echo '<h1 class="header__title container">Изготовление памятников из гранита и мрамора</h1>';}
		?>
...
<noscript><div><img src="https://mc.yandex.ru/watch/84880456" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->
