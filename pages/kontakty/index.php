    ...
    <section class="contacts-page__section contacts-page__contacts contacts">
      <div class="contacts__container container">
        ...
        <div class="contacts__item contacts__item_phone">
          ...
          <a class="contacts__link contacts__link_phone phone-info" href="tel:<? echo preg_replace('/[^0-9\.]+/', '', $row1['tel']); ?>">
            <? echo $row1['tel']; ?>
          </a>
        ...
        <div class="contacts__item contacts__item_mail">
          ...
          <a class="contacts__link contacts__link_mail email-info" href="mailto:<? echo $row1['email']; ?>">
            <? echo $row1['email']; ?>
          </a>
        </div>
          ...
          <div>
            <ul class="contacts__geo-card-wrap">
              <li class="contacts__geo-card">
                <a class="contacts__geo-link contacts__geo-link_telegram telegram-info" target="_blank" href="https://t.me/+<? echo preg_replace('/[^0-9\.]+/', '', $row1['tel']); ?>">
              ...
              <li class="contacts__geo-card">
                <a class="contacts__geo-link contacts__geo-link_viber viber-info" target="_blank" href="viber://chat?number=%2B<? echo preg_replace('/[^0-9\.]+/', '', $row1['tel']); ?>">
