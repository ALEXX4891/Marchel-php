          ...
          <div>
            <ul class="contacts__geo-card-wrap">
              <li class="contacts__geo-card">
                <a class="contacts__geo-link contacts__geo-link_telegram telegram-info" target="_blank" href="https://t.me/+<? echo preg_replace('/[^0-9\.]+/', '', $cont['messenger-tel']); ?>">
              ...
              <li class="contacts__geo-card">
                <a class="contacts__geo-link contacts__geo-link_whatsapp whatsapp-info" href="https://api.whatsapp.com/send?phone=<? echo preg_replace('/[^0-9\.]+/', '', $cont['messenger-tel']); ?>" target="_blank">
              ...
              <li class="contacts__geo-card">
                <a class="contacts__geo-link contacts__geo-link_viber viber-info" target="_blank" href="viber://chat?number=%2B<? echo preg_replace('/[^0-9\.]+/', '', $cont['messenger-tel']); ?>">
