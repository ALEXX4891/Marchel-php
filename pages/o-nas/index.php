    ...
    <section class="about-us-page__section about-us-page__services services">
      <div class="services__container container">
        ...
        <ul class="services__card-wrap">
          <?
          $result = mysqli_query($db, "SELECT * FROM services ORDER BY RAND() LIMIT 8");
          ...
          <div class="big-form__geo-wrap">
            ...
            <ul class="big-form__geo-card-wrap">
              <li class="big-form__geo-card">
                <a class="big-form__geo-link big-form__geo-link_telegram telegram-info" target="_blank" href="https://t.me/+<? echo preg_replace('/[^0-9\.]+/', '', $row1['tel']); ?>">
              ...
              <li class="big-form__geo-card">
                <a class="big-form__geo-link big-form__geo-link_whatsapp whatsapp-info" target="_blank" href="https://api.whatsapp.com/send?phone=<? echo preg_replace('/[^0-9\.]+/', '', $row1['tel']); ?>">
              ...
              <li class="big-form__geo-card big-form__geo-link_viber">
                <a class="big-form__geo-link viber-info" target="_blank" href="viber://chat?number=%2B<? echo preg_replace('/[^0-9\.]+/', '', $row1['tel']); ?>">
