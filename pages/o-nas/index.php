...
$resultNews = mysqli_query($db, "SELECT * FROM news ORDER BY DATE DESC LIMIT 3");
          ...
          <div class="big-form__geo-wrap">
            ...
            <ul class="big-form__geo-card-wrap">
              ...
              <li class="big-form__geo-card big-form__geo-link_viber">
                <a class="big-form__geo-link viber-info" target="_blank" href="viber://chat?number=%2B<? echo preg_replace('/[^0-9\.]+/', '', $cont['tel']); ?>">
