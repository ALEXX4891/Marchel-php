        ...
        <ul class="work__card-wrap">
          <li class="work__card">
            ...
            <div class="work__card-text-wrap">
              ...
              <a class="work__card-link phone-info" href="tel:<? echo preg_replace('/[^0-9\.]+/', '', $row['tel']); ?>">
        ...
        <div class="work__geo-wrap">
          ...
          <ul class="work__geo-card-wrap">
            <li class="work__geo-card">
              <a class="work__geo-link work__geo-link_telegram telegram-info" target="_blank" href="https://t.me/+<? echo preg_replace('/[^0-9\.]+/', '', $row['tel']); ?>">
            ...
            <li class="work__geo-card">
              <a class="work__geo-link work__geo-link_whatsapp whatsapp-info" target="_blank" href="https://api.whatsapp.com/send?phone=<? echo preg_replace('/[^0-9\.]+/', '', $row['tel']); ?>">
            ...
            <li class="work__geo-card">
              <a class="work__geo-link work__geo-link_viber viber-info" target="_blank" href="viber://chat?number=%2B<? echo preg_replace('/[^0-9\.]+/', '', $row['tel']); ?>">
          ...
          <div class="big-form__geo-wrap">
            ...
            <ul class="big-form__geo-card-wrap">
              ...
              <li class="big-form__geo-card big-form__geo-link_viber">
                <a class="big-form__geo-link viber-info viber-info" target="_blank" href="viber://chat?number=%2B<? echo preg_replace('/[^0-9\.]+/', '', $row['tel']); ?>">
                  <svg width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd"
